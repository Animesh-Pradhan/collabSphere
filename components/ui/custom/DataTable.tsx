...
export default function DataTable<T>({
    noDataTitle = "No Members available!",
    noDataDescription = "Invite members across the world.",
    data,
    columns,
    pageCount,
    totalItems,
    ...
    return (
        <Box boxShadow={'md'} borderRadius="md" overflow="hidden">
                        ...
                        {table.getRowModel().rows.length === 0 && (
                            <Table.Row>
                                <Table.Cell colSpan={columns.length + 1}>
                                    <UIEmptyBox icon={IoPersonOutline} title={noDataTitle} description={noDataDescription} />
                                </Table.Cell>
                            </Table.Row>
                        )}
            ...
            <Flex justify="space-between" align="center" px="2" py="3" borderTopWidth="1px" borderColor="pallete.borderSubtle">
                ...
                {totalItems > pagination.pageSize && <UIPagination
