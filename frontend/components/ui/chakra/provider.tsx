    ...
    semanticTokens: {
      colors: {
        pallete: {
          ...
          secondary: { value: { base: "#000", _dark: "#34094e" } },
          secondary_hover: { value: { base: "#202020", _dark: "#501277" } },
          tertiary: { value: { base: "#f3f3f3", _dark: "#0e0e0e" } },
          surfaceElevated: { value: { base: "#ffffff", _dark: "#181818" } },
          surfaceElevated2: { value: { base: "#f1f1f1", _dark: "#242424" } },
          canvas: { value: { base: "#fffefa", _dark: "#09090b" } },
          borderSubtle: { value: { base: "#e5e5e5", _dark: "#3d3d3d" } }
        },
        bg: {
          primary: { value: { base: "#fff", _dark: "#000" } },
        ...
        text: {
          ...
          secondary: { value: { base: "#989898", _dark: "#676767" } },
        },
        button: {
